...
model TestCase2 "Test Case 2, Section 5.2, focuses on the dynamic behavior of the model for the synchronous generator and its governor"
  ...
  Modelica.Blocks.Sources.RealExpression zero2 annotation (
    Placement(visible = true, transformation(origin={-26,-54},   extent = {{-12, -10}, {12, 10}}, rotation = 0)));
...
equation
  connect(GEN.VPu, AVR.VcPu) annotation (
    Line(points={{-16,-6},{0,-6},{0,52},{-112,52},{-112,-14},{-72,-14}},              color = {0, 0, 127}));
  connect(zero2.y, LOAD.QRefIn) annotation (
    Line(points={{-12.8,-54},{10,-54},{10,-48},{22,-48}},                 color = {0, 0, 127}));
  connect(zero.y, AVR.VuelPu) annotation (
    Line(points={{-90.8,-40},{-78,-40},{-78,-22},{-72,-22}},              color = {0, 0, 127}));
  connect(zero.y, AVR.VsPu) annotation (
    Line(points={{-90.8,-40},{-80,-40},{-80,-10},{-72,-10}},        color = {0, 0, 127}));
  connect(VrefPu.y, AVR.VrefPu) annotation (
    Line(points={{-90.8,-25},{-85.8,-25},{-85.8,-18},{-72,-18}},          color = {0, 0, 127}));
  connect(PLoad.y, LOAD.PRefIn) annotation (
    Line(points={{0.8,-34},{10,-34},{10,-42},{22,-42}},        color = {0, 0, 127}));
  ...
  connect(TGOV.PMechPu, GEN.PmPu) annotation (
    Line(points={{-51.82,28},{-44,28},{-44,4},{-40,4},{-40,4},{-36,4}},           color = {0, 0, 127}));
