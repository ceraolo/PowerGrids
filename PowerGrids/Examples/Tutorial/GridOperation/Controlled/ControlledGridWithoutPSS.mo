...
equation
  ...
  connect(AVR.VsPu, zero.y) annotation (
    Line(points = {{-72, -10}, {-76, -10}, {-76, -48}, {-89, -48}}, color = {0, 0, 127}));
  connect(AVR.VuelPu, zero.y) annotation (
    Line(points = {{-72, -22}, {-76, -22}, {-76, -48}, {-89, -48}}, color = {0, 0, 127}));
  ...
  connect(GEN.VPu, AVR.VcPu) annotation (
    Line(points = {{-16, -6}, {-6, -6}, {-6, 48}, {-112, 48}, {-112, -14}, {-72, -14}}, color = {0, 0, 127}));
